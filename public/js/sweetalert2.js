  ...
  const n = "swal2-",
    ...
    N = (e, t) => {
      ...
      switch (t) {
        ...
        case "radio":
          return (
            e.querySelector(`.${i.popup} > .${i.radio} input:checked`) || e.querySelector(`.${i.popup} > .${i.radio} input:first-child`)
          );
        case "range":
        ...
        (function (e, t, o) {
          ...
          ue(n, "confirm", o),
            ...
            (function (e, t, o, n) {
              ...
              R([e, t, o], i.styled),
                n.confirmButtonColor && ((e.style.backgroundColor = n.confirmButtonColor), R(e, i["default-outline"]));
            ...
            o.reverseButtons &&
              (o.toast ? (e.insertBefore(r, n), e.insertBefore(s, n)) : (e.insertBefore(r, t), e.insertBefore(s, t), e.insertBefore(n, t)));
        })(o, n, t),
        D(n, t.loaderHtml || ""),
        V(n, t, "loader"));
    };
  ...
  const pe = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
    ...
    we = (e, t) => {
      ["string", "number"].includes(typeof t)
        ? (e.value = `${t}`)
        : h(t) || l(`Unexpected type of inputValue! Expected "string", "number" or "Promise", got "${typeof t}"`);
    },
    ve = {};
  (ve.text =
    ve.email =
        ...
        setTimeout(() => {
          if ("MutationObserver" in window) {
            ...
            new MutationObserver(() => {
              ...
              const n =
                e.offsetWidth +
                ((i = e), parseInt(window.getComputedStyle(i).marginLeft) + parseInt(window.getComputedStyle(i).marginRight));
              var i;
          ...
          if (i) {
            ...
            if (t.icon || t.iconHtml) {
              if (t.icon && -1 === Object.keys(s).indexOf(t.icon))
                return c(`Unknown icon! Expected "success", "error", "warning", "info" or "question", got "${t.icon}"`), void Y(i);
  ...
  const Re = () => {
    ...
    We = (e) => {
      ...
      return (
        ...
        !Ye(e) &&
        (t === o ||
          (!G(o) && t instanceof HTMLElement && "INPUT" !== t.tagName && "TEXTAREA" !== t.tagName && (!G(A()) || !A().contains(t))))
      );
    },
        ...
        "object" != typeof e[0] || oo(e[0])
          ? ["title", "html", "icon"].forEach((o, n) => {
              ...
              "string" == typeof i || oo(i)
                ? (t[o] = i)
                : void 0 !== i && c(`Unexpected type of ${o}! Expected "string" or "Element", got ${typeof i}`);
            })
          : Object.assign(t, e[0]),
        t
      );
